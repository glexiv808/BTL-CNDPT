        ...
        <div class="row border-top px-xl-5">
            <div class="col-lg-3 d-none d-lg-block">
                <a class="d-flex align-items-center justify-content-between bg-secondary w-100 text-decoration-none" data-toggle="collapse" href="#navbar-vertical" style="height: 67px; padding: 0 30px;">
                    <h5 class="text-primary m-0"><i class="fa fa-book-open mr-2"></i>Khóa học</h5>
                    <i class="fa fa-angle-down text-primary"></i>
                </a>
                <nav class="collapse position-absolute navbar navbar-vertical navbar-light align-items-start p-0 border border-top-0 border-bottom-0 bg-light" id="navbar-vertical" style="width: calc(100% - 30px); z-index: 9;">
                    <div class="navbar-nav w-100">
                        <div class="nav-item dropdown">
                            <a href="#" class="nav-link" data-toggle="dropdown">Chứng khoán<i class="fa fa-angle-down float-right mt-1"></i></a>
                            <div class="dropdown-menu position-absolute bg-secondary border-0 rounded-0 w-100 m-0">
                                <a href="" class="dropdown-item">Chứng khoán cơ bản</a>
                                <a href="" class="dropdown-item">Đọc hiểu báo cáo tài chính</a>
                                <a href="" class="dropdown-item">Bắt đáy và chốt lời cổ phiếu</a>
                            </div>
                        </div>
                        <a href="" class="nav-item nav-link">Phân tích kĩ thuật nâng cao</a>
                        <a href="" class="nav-item nav-link">Phân tích ngành và Dòng tiền thị trường</a>
                        <a href="" class="nav-item nav-link">Phân tích kĩ thuật ứng dụng</a>
                        <a href="" class="nav-item nav-link">Phân tích và định giá cổ phiếu</a>
                    </div>
                </nav>
            </div>
            <div class="col-lg-9">
                <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        ...
                        <a class="btn btn-primary py-2 px-4 ml-auto d-none d-lg-block" href="">Đăng kí ngay</a>
                    </div>
                </nav>
            </div>
        </div>
            ...
            <div class="carousel-inner">
                <div class="carousel-item active" style="min-height: 300px;">
                    ...
                    <div class="carousel-caption d-flex align-items-center justify-content-center">
                        <div class="p-5" style="width: 100%; max-width: 900px;">
                            ...
                            <h1 class="display-3 text-white mb-md-4">Xây dựng nền tảng cho hành trình đầu tư tài chính của bạn</h1>
                ...
                <div class="carousel-item" style="min-height: 300px;">
                    ...
                    <div class="carousel-caption d-flex align-items-center justify-content-center">
                        <div class="p-5" style="width: 100%; max-width: 900px;">
                            <h5 class="text-white text-uppercase mb-md-3">Best Online Courses</h5>
                            <h1 class="display-3 text-white mb-md-4">Dễ dàng học, áp dụng thực tế trên thương trường</h1>
                            <a href="" class="btn btn-primary py-md-2 px-md-4 font-weight-semi-bold mt-2">Tìm hiểu ngay</a>
                        </div>
                    </div>
                </div>
            ...
            <div class="row align-items-center">
                <div class="col-lg-7 mb-5 mb-lg-0">
                    <div class="mb-4">
                        ...
                        <h1 class="text-white"> GIẢM NGAY 30% cho học viên mới</h1>
                    </div>
                            ...
                            <form>
                                ...
                                <div class="form-group">
                                    <select class="custom-select border-0 px-4" style="height: 47px;">
                                        ...
                                        <option value="1">Chứng khoán cơ bản</option>
                                        <option value="2">Đọc hiểu báo cáo tài chính</option>
                                        <option value="3">Phân tích thị trường</option>
                                    </select>
                                </div>
                                <div>
                                    <button class="btn btn-dark btn-block border-0 py-3" type="submit">Tham gia ngay</button>
                                </div>
                            </form>
                        </div>
                    </div>
    ...
    <div class="container-fluid py-5">
        <div class="container pt-5 pb-3">
            <div class="text-center mb-5">
                ...
                <h1>Điểm qua đội ngủ giảng viên</h1>
            </div>
            <div class="row">
                <div class="col-md-6 col-lg-3 text-center team mb-4">
                    <div class="team-item rounded overflow-hidden mb-2">
                        ...
                        <div class="bg-secondary p-4">
                            <h5>Nguyễn Đức Nguyên</h5>
                            <p class="m-0">CMT Charterholder, Thành viên Hiệp hội PTKT Hoa Kỳ (MTA)</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-lg-3 text-center team mb-4">
                    <div class="team-item rounded overflow-hidden mb-2">
                        ...
                        <div class="bg-secondary p-4">
                            <h5>Ngô Quốc Việt</h5>
                            <p class="m-0">Trưởng phòng Phân tích - Phụ trách Bộ phận Chiến lược - Chứng Khoán KIS Việt Nam</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-lg-3 text-center team mb-4">
                    <div class="team-item rounded overflow-hidden mb-2">
                        ...
                        <div class="bg-secondary p-4">
                            <h5>Trần Văn Long</h5>
                            <p class="m-0">Chuyên viên Cao cấp - Bộ phận Đầu tư, Dragon Capital
                ...
                <div class="col-md-6 col-lg-3 text-center team mb-4">
                    <div class="team-item rounded overflow-hidden mb-2">
                        ...
                        <div class="bg-secondary p-4">
                            <h5>Lương Quốc Anh</h5>
                            <p class="m-0">Giám đốc quản lý danh mục đầu tư</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row pb-3">
                <div class="col-lg-4 mb-4">
                    <div class="blog-item position-relative overflow-hidden rounded mb-2">
                        ...
                        <a class="blog-overlay text-decoration-none" href="">
                            <h5 class="text-white mb-3">Thông báo Lịch khai giảng các khóa đào tạo cấp chứng chỉ chuyên môn chứng khoán tháng 11/2024 tại Hà Nội</h5>
                            <p class="text-primary m-0">01-11-2024 </p>
                        </a>
                    </div>
                </div>
                <div class="col-lg-4 mb-4">
                    <div class="blog-item position-relative overflow-hidden rounded mb-2">
                        ...
                        <a class="blog-overlay text-decoration-none" href="">
                            <h5 class="text-white mb-3">Thông báo tổ chức kì thi cấp chứng chỉ chuyên môn chứng khoán tại Hà Nội, mã kì thi: KTCM072024</h5>
                            <p class="text-primary m-0">01-11-2024 </p>
                        </a>
                    </div>
                </div>
                <div class="col-lg-4 mb-4">
                    <div class="blog-item position-relative overflow-hidden rounded mb-2">
                        ...
                        <a class="blog-overlay text-decoration-none" href="">
                            <h5 class="text-white mb-3">Quy trình quản lý thu, chi học phí tại Trung tâm Nghiên cứu khoa học và Đào tạo chứng khoán</h5>
                            <p class="text-primary m-0">05-11-2024</p>
                        </a>
                    </div>
                </div>
            </div>
